            ...
            if(result.equals("true")){
                ...
                ald.setButton("OK",new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        //i.putExtra("AppUserID",CustomerID);
                        Bundle opt=new Bundle(1);
                        opt.putString("AppUserID",CustomerID);
                        startActivityForResult(i,2,opt);
                        finish();
                    }
                });
                ald.show();
                ...
                Toast.makeText(getApplicationContext(), "on False", Toast.LENGTH_LONG).show();
            }
            else{
